		...
		<aside class="sm-side">
			<div class="user-head">
				...
				<div class="user-name">
					...
					<span><a href="#">Info.AACII.goodjob.com</a></span>
				</div>
            </div>
			<div class="inbox-body">
				...
				<ul class="nav nav-pills nav-stacked labels-info inbox-divider middle-navigation">
					<li> <h4>List</h4> </li>
					<li> <a href="#"> <i class=" fa fa-sign-blank text-danger"></i> Postodo </a> </li>
			...
			<div class="inbox-body">
				<div class="mail-option">
					<ul class="unstyled inbox-pagination">
						<button id="btnWriteBoard" name="btnWriteBoard" class="btn btn-info btn-bg">글쓰기</button>
					</ul>
				</div>
